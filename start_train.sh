...
# train c_atm
python catm_main.py --taskname  20news_clean  --n_topic 75 --num_epochs 50000 --train True --language en --clean_data True --batch_size 256
# python catm_main.py --taskname  20news_clean  --n_topic 20 --num_epochs 50000 --language en --clean_data True --bkpt_continue True --batch_size 256 --train True
