...
class WLDA(object):
    ...
    def train(self, train_data, batch_size=64, clip=0.01, lr=1e-4, test_data=None, epochs=100, beta_1=0.5,
        ...
        optimizer = torch.optim.Adam(self.wae.parameters(), lr=lr, betas=(beta_1, beta_2))
            ...
            if epoch % 250 == 0 and epoch is not 0:
                if test_data is not None:
                    ...
                    if self.max_npmi_value < npmi:
                        ...
                        self.save_model_ckpt(optim_g=optimizer, optim_e=optim_e, optim_d=optim_d, epoch=epoch,
